...
def get_optional_activities():
    ...
    return {
        ...
        "🦞 Seafood & Waterfront": [
            ...
            {"name": "Salty Pelican Bar & Grill", "description": "Heart of downtown waterfront, blackened grouper tacos, fresh oysters, fried tuna. ✅ NON-SEAFOOD: Burgers, chicken sandwiches, steaks", "cost_range": "$18-35 per person", "duration": "1-2 hours", "phone": "904-277-3811", "booking_url": "https://saltypelican.com", "tips": "Best place to catch sunset over the river. Full bar & grill menu with chicken, burgers, steaks!", "rating": "4.6/5"},
