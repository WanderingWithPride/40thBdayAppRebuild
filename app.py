...
def get_optional_activities():
    ...
    return {
        ...
        "🦞 Seafood & Waterfront": [
            ...
            {"name": "Timoti's Seafood Shak", "description": "SARAH'S RECOMMENDATION for lunch! Family-friendly wild-caught seafood, fresh fried shrimp, poke bowls, fish tacos, lobster rolls", "cost_range": "$12-25 per person", "duration": "45min-1 hour", "phone": "904-206-0965", "booking_url": "https://timotis.com", "tips": "Sarah says: 'You must go to Timotees for lunch one day!' Fast casual, super fresh seafood", "rating": "4.6/5"},
