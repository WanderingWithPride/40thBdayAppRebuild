...
def get_optional_activities():
    ...
    return {
        ...
        "🏊 Resort Pools & Hotel Activities": [
            ...
            {"name": "Beach Bonfires", "description": "Private or group beach bonfire with s'mores, blankets, and stargazing", "cost_range": "Call for pricing (904-277-1100)", "duration": "2 hours", "phone": "904-277-1100", "booking_url": "ritzcarltonameliaisland.ipoolside.com", "tips": "Perfect for special celebrations! Book through ipoolside.com or call. Can do every evening!", "rating": "4.9/5", "is_repeatable": True, "time_preference": "evening"},
